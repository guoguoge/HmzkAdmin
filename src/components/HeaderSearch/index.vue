...
<div :class="{'show':show}" class="header-search">
  ...
  搜索
  <el-select ref="headerSearchSelect" v-model="search" :remote-method="querySearch" filterable default-first-option remote placeholder="搜索页面关键词" class="header-search-select" @change="change">
